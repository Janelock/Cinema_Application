        ...
        child: Row(
          children: [
            CircleAvatar(
              ...
              child: Container(
                ...
                child: CircleAvatar(
                  ...
                  radius:45,
                  backgroundImage:NetworkImage('https://movieposters2.com/images/782572-b.jpg') ,
            ...
            Column(
              ...
              children: [
                Text('Titanic' ,style: TextStyle(color: Colors.white , fontSize:30 ),),
                SizedBox(height: 15,),
                Text('\$100',style: TextStyle(color: Colors.orangeAccent , fontSize:25 ),),
