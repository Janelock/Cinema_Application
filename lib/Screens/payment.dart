...
Widget PaymentSheet({required String userName,required int countTickets}) {
  return Scaffold(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                          ...
                          validator: (value){
                            ...
                            if(int.parse(month)<1 || int.parse(month)>12||value[2]!='/'){
                ...
                TextFormField(
                    validator: (value){
                      ...
                      for(int i=0;i<value.length;i++){
                        if(value[i]!=' ' && !RegExp(r'^[a-zA-z]').hasMatch(value)){
                          return "Invalid input";
                        }
                      }
                      return null;
                    ...
                    decoration:const InputDecoration(fillColor: Color(0xff302d2d), filled: true,)
                ),
                const SizedBox(height: 30,),
                points>0?
                CheckboxListTile(
                    ...
                    value: check ,
                    title:Text("Apply a discount of "+(min(initialPoints,initialPrice)).toString()+" using points.",
                      style: const TextStyle(color: Colors.white),) ,
                ...
                Center(
                    child: defaultButton(
                        text: "\$"+(countTickets*100).toString(),
                        textColor: Colors.white,
                        background: Colors.orangeAccent,
                        radius: 30,
                        width: 200,
                        function: (){
                          Provider.of<providerSeats>(context, listen: false).reservation();
                          ...
                          if(isValidCardNum && isValidCvv && isValidEd && isValidChn) {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context)=> TransitionScreen(UserName: userName,)));
