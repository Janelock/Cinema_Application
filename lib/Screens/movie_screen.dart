...
class MovieScreen extends StatefulWidget {
  ...
  MovieScreen({Key? key,this.title,this.image,this.rating,this.genre,this.description,required this.UserName}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.transparent,
        title: Text(
          widget.title.toString(), style: TextStyle(color: Colors.white),),
        leading: IconButton(
          onPressed: () {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      gradientButton(
                        function:(){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=> MultiSelectscreen(UserName: widget.UserName,)));
                        },
                  ...
                  StreamBuilder<List<Review>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasError) {
                        ...
                        return Text("No Reviews",style: TextStyle(color: Colors.white),);
                      }
                    },
                  ),
